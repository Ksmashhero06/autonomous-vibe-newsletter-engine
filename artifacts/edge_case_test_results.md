...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1.1 | **Deep Dive: Building a React 19 Compiler fr...** | AI & Agentic Frameworks | SUCCESS | 1 | Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks). | 🚫 Blocked | ✅ Yes | 95 |
...
| 3.1 | **Evaluating WebAssembly (WASM) Compilation ...** | AI & Agentic Frameworks | SUCCESS | 1 | Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks). | 🚫 Blocked | ✅ Yes | 95 |
...
| 5.1 | **Demystifying eBPF: Attaching Kernel Probes...** | AI & Agentic Frameworks | SUCCESS | 1 | Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks). | 🚫 Blocked | ✅ Yes | 95 |
...
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `1.66s`
...
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `2.05s`
- **Memory Duplication Blocked:** `YES`
- **Security/Formatting Violations:** `['Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks).']`
...
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `1.84s`
- **Memory Duplication Blocked:** `YES`
- **Security/Formatting Violations:** `['Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks).']`
...
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `2.68s`
- **Memory Duplication Blocked:** `YES`
- **Security/Formatting Violations:** `['Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks).']`
...
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `1.99s`
- **Memory Duplication Blocked:** `YES`
- **Security/Formatting Violations:** `['Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks).']`
...
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `2.19s`
- **Memory Duplication Blocked:** `YES`
- **Security/Formatting Violations:** `['Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks).']`
...
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `2.53s`
- **Memory Duplication Blocked:** `YES`
- **Security/Formatting Violations:** `['Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks).']`
...
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `1.52s`
- **Memory Duplication Blocked:** `YES`
- **Security/Formatting Violations:** `['Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks).']`
...
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `2.32s`
- **Memory Duplication Blocked:** `YES`
- **Security/Formatting Violations:** `['Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks).']`
...
- **Goal:** Tests exact duplication check by running twice in a row.
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `2.23s`
- **Memory Duplication Blocked:** `YES`
- **Security/Formatting Violations:** `['Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks).']`
...
- **Status:** `success` | **Attempts:** `1` | **Evaluator Score:** `95/100` | **Fact Checker Score:** `0%` | **Duration:** `2.61s`
- **Memory Duplication Blocked:** `YES`
- **Security/Formatting Violations:** `['Formatting Violation: Unclosed markdown code block detected (odd number of triple-backticks).']`
